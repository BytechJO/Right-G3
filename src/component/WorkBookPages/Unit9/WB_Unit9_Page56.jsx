...
import page2 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U9 Folder/Page 56.png";
import "./WB_unit9.css";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
        className="q13-9 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
    ...
    <div
        className="q14-9 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
