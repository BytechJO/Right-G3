...
const WB_Unit7_Page27_Q1 = () => {
  ...
  const data = [
    { id: 1, img: img1, options: ["bathroom", "garage", "bedroom"], correct: "bedroom" },
    { id: 2, img: img2, options: ["dining room", "basement", "hall"], correct: "dining room" },
    { id: 3, img: img3, options: ["kitchen", "living room", "dining room"], correct: "kitchen" },
    { id: 4, img: img4, options: ["living room", "office", "basement"], correct: "office" },
    { id: 5, img: img5, options: ["basement", "garage", "kitchen"], correct: "basement" },
    { id: 6, img: img6, options: ["hall", "bathroom", "stairs"], correct: "bathroom" },
  ];
