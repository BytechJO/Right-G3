...
import imgHouse from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U7 Folder/Page 39/SVG/1.svg";

const ACTIVITIES = [
  { id: "act1", text: "Yes, I can see him by the tree." },
  { id: "act2", text: "Yes, I can see it in the kitchen." },
  { id: "act3", text: "Yes, I can see him near the bed in the bedroom." },
  { id: "act4", text: "Yes, I can see her in front of the washing machine in the basement." },
];
...
const QUESTIONS = [
  { id: "q1", text: "1. Can you see Hansel?" },
  { id: "q2", text: "2. Can you see the cat?" },
  { id: "q3", text: "3. Can you see Dad?" },
  { id: "q4", text: "4. Can you see Mom?" },
];
