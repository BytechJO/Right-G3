...
export default function WB_Unit8_Page58_QD() {
  ...
  const handleCheck = () => {
   ...
   if (correct === total) ValidationAlert.success(`Score: ${correct} / ${total}`);
    else if (correct > 0) ValidationAlert.warning(`Score: ${correct} / ${total}`);
        ...
        {selected && (
          <div
            style={{
              position: "absolute",
              inset: "-2px -4px",
              border: wrong ? `2px solid red` : `1px solid ${SELECT_COLOR}`,
              borderRadius: "999px",
              pointerEvents: "none",
    ...
    <div className="main-container-component">
      <div className="div-forall" style={{ gap: "clamp(18px,2.5vw,30px)" }}>
        ...
        <h1 className="WB-header-title-page8">
          <span className="WB-ex-A">D</span>Look, read, and tap or click. Speak.
        </h1>
