...
const data = [
  { question: "", correct: "That is a duck." },
  { question: "", correct: "Those are flowers." },
  { question: "", correct: "That is a tree." },
  { question: "", correct: "This is a bird." },
];
        ...
        >
          <div className="component-wrapper">
           ...
           <span style={{ marginRight: "20px" }}>D</span>  Look and write.
            ...
            <div className="content-wb-CB-review2-p1-q2">
              <div className="group-input-CB-review2-p1-q2">
                {data.map((item, index) => (
                  <div
                    key={index}
                        ...
                        {(provided, snapshot) => (
                          ...
                          >
                            ...
                            {wrongInputs.includes(index) && (
                              <span className="wrong-icon-CB-review2-p1-q2">
                                ✕
                              </span>
                            )}
                          </div>
