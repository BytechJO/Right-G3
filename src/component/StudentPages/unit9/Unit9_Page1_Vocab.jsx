...
import backgroundImage from "../../../assets/imgs/pages/classbook/Right 3 Unit 9 Where Dad Folder/G5_U9_Pg_76.png";
...
const Unit5_Page1_Vocab = () => {
  ...
  const positions = [
    ...
    { top: "9.5%", left: "26%" }, //3
    { top: "5%", left: "5%" }, //4
    { top: "40.8%", left: "90.5%" }, //5
    { top: "54.5%", left: "49.5%" }, //6
    { top: "89%", left: "19.5%" }, //7
    { top: "70.5%", left: "27%" }, // 8
    { top: "81.5%", left: "71%" }, //9
    { top: "48.5%", left: "63.5%" }, //10
    { top: "67.5%", left: "56%" }, //11
    { top: "30.5%", left: "47%" }, //12
    { top: "80.5%", left: "52%" }, //13
    { top: "31%", left: "61%" }, //14
